...
- Verification: `npm run art:generate-crossroads-overlays -- --filter image-memory-parlor-neon-001`, `node scripts/art/analyzeCrossroadsOverlays.js --dir assets/generated/ar-050`, `npm run art:export-crossroads-luminance`.
