...
export class DialogueBox {
  ...
  constructor(ctx, eventBus, config = {}) {
    ...
    this.config = {
      ...
      choiceFontSize: config.choiceFontSize || 14,
      lineHeight: config.lineHeight || 24,
      backgroundColor: config.backgroundColor || 'rgba(0, 0, 0, 0.85)',
      borderColor: config.borderColor || '#4A90E2',
      textColor: config.textColor || '#FFFFFF',
      choiceColor: config.choiceColor || '#AADDFF',
      choiceHoverColor: config.choiceHoverColor || '#FFDD44',
      speakerColor: config.speakerColor || '#4A90E2',
      typewriterSpeed: config.typewriterSpeed || 50, // ms per character
  ...
  show(data) {
    ...
    this.canAdvance = data.canAdvance || false;
    this.hasChoices = data.hasChoices || false;
    this.selectedChoiceIndex = 0;
