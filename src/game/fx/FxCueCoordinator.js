...
export class FxCueCoordinator {
  ...
  constructor(eventBus, options = {}) {
    ...
    const defaultDurations = {
      ...
      detectiveVisionRainfall: 720,
      detectiveVisionNeonBloom: 640,
      detectiveVisionMemoryFragmentBurst: 820,
    ...
    const perEffectLimit = {
      ...
      detectiveVisionRainfall: 1,
      detectiveVisionNeonBloom: 1,
      detectiveVisionMemoryFragmentBurst: 1,
