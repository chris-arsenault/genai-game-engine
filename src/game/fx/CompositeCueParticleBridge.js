...
export class CompositeCueParticleBridge {
  ...
  constructor(eventBus, options = {}) {
    ...
    const defaultMappings = {
      ...
      disguiseOverlayReveal: {
        preset: 'disguise-overlay-reveal',
        baseIntensity: 0.6,
        maxIntensity: 0.86,
        spawnCount: 18,
        cooldownMs: 240,
      ...
      disguiseOverlayDismiss: {
        preset: 'disguise-overlay-dismiss',
        baseIntensity: 0.45,
        maxIntensity: 0.72,
        spawnCount: 12,
        cooldownMs: 220,
      },
      disguiseSelectionFocus: {
        preset: 'disguise-selection-focus',
        baseIntensity: 0.52,
        maxIntensity: 0.8,
        spawnCount: 12,
        cooldownMs: 180,
      ...
      disguiseUnequipIntent: {
        preset: 'disguise-unequip-intent',
        baseIntensity: 0.48,
        maxIntensity: 0.78,
        spawnCount: 14,
        cooldownMs: 220,
      },
      interactionPromptReveal: {
        preset: 'interaction-prompt-reveal',
        baseIntensity: 0.55,
        maxIntensity: 0.8,
        spawnCount: 14,
        cooldownMs: 220,
      },
      interactionPromptUpdate: {
        preset: 'interaction-prompt-update',
        baseIntensity: 0.5,
        maxIntensity: 0.76,
        spawnCount: 10,
        cooldownMs: 200,
      },
      interactionPromptDismiss: {
        preset: 'interaction-prompt-dismiss',
        baseIntensity: 0.45,
        maxIntensity: 0.7,
        spawnCount: 10,
        cooldownMs: 200,
      },
      movementIndicatorPulse: {
        preset: 'movement-indicator-pulse',
        baseIntensity: 0.58,
        maxIntensity: 0.85,
        spawnCount: 16,
        cooldownMs: 200,
      },
      objectiveListRefresh: {
        preset: 'case-objective-arc',
        baseIntensity: 0.6,
        maxIntensity: 0.85,
        spawnCount: 16,
      ...
      crossroadsBranchLandingDismiss: {
        preset: 'case-clue-shimmer',
        baseIntensity: 0.5,
        maxIntensity: 0.76,
        spawnCount: 12,
      ...
      saveInspectorOverlayReveal: {
        preset: 'save-inspector-overlay-reveal',
        baseIntensity: 0.58,
        maxIntensity: 0.82,
        spawnCount: 16,
        cooldownMs: 260,
      ...
      saveInspectorOverlayDismiss: {
        preset: 'save-inspector-overlay-dismiss',
        baseIntensity: 0.42,
        maxIntensity: 0.68,
        spawnCount: 10,
        cooldownMs: 220,
      },
      saveInspectorOverlayRefresh: {
        preset: 'save-inspector-overlay-refresh',
        baseIntensity: 0.5,
        maxIntensity: 0.76,
        spawnCount: 12,
        cooldownMs: 300,
      },
      tutorialOverlayReveal: {
        preset: 'tutorial-overlay-reveal',
        baseIntensity: 0.58,
        maxIntensity: 0.82,
        spawnCount: 14,
        cooldownMs: 240,
      },
      tutorialOverlayDismiss: {
        preset: 'tutorial-overlay-dismiss',
        baseIntensity: 0.45,
        maxIntensity: 0.7,
        spawnCount: 12,
        cooldownMs: 220,
      ...
      controlBindingsOverlayReveal: {
        preset: 'control-bindings-overlay-reveal',
        baseIntensity: 0.6,
        maxIntensity: 0.84,
        spawnCount: 18,
        cooldownMs: 280,
      },
      controlBindingsOverlayDismiss: {
        preset: 'control-bindings-overlay-dismiss',
        baseIntensity: 0.44,
        maxIntensity: 0.7,
        spawnCount: 12,
        cooldownMs: 240,
      },
      controlBindingsSelectionFocus: {
        preset: 'control-bindings-selection',
        baseIntensity: 0.54,
        maxIntensity: 0.78,
        spawnCount: 14,
        cooldownMs: 160,
      },
      controlBindingsCaptureStart: {
        preset: 'control-bindings-capture-start',
        baseIntensity: 0.62,
        maxIntensity: 0.88,
        spawnCount: 18,
        cooldownMs: 260,
      ...
      controlBindingsCaptureCancel: {
        preset: 'control-bindings-capture-cancel',
        baseIntensity: 0.46,
        maxIntensity: 0.7,
        spawnCount: 12,
        cooldownMs: 220,
      },
      controlBindingsCaptureApplied: {
        preset: 'control-bindings-capture-applied',
        baseIntensity: 0.68,
        maxIntensity: 0.9,
        spawnCount: 20,
        cooldownMs: 280,
      ...
      controlBindingsBindingReset: {
        preset: 'control-bindings-binding-reset',
        baseIntensity: 0.5,
        maxIntensity: 0.76,
        spawnCount: 12,
        cooldownMs: 240,
      },
      controlBindingsListModeChange: {
        preset: 'control-bindings-list-mode',
        baseIntensity: 0.5,
        maxIntensity: 0.74,
        spawnCount: 12,
        cooldownMs: 220,
      },
      controlBindingsPageChange: {
        preset: 'control-bindings-page-change',
        baseIntensity: 0.48,
        maxIntensity: 0.72,
        spawnCount: 12,
        cooldownMs: 200,
